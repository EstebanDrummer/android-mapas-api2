...
import com.seminario.android.campusmap.BaseDatosHelper;
import com.seminario.android.campusmap.Lugar;
						...
						// edit text
					    	...
					    	if(TwitterUtils.isAuthenticated(prefs)){
					    		...
					    		AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
					    				context);
					    		// set title
								alertDialogBuilder.setTitle("Autorizaci??n");
								...
								.setNegativeButton("No",new DialogInterface.OnClickListener() {
									public void onClick(DialogInterface dialog,int id) {
										Toast.makeText(context, "No se public?? en twitter",Toast.LENGTH_LONG).show();
										dialog.cancel();
									}
								});
...
(
	...
	{	
		...
		{ 
			...
			case R.id.menu_recreation:
				...
				String infoSO ="Creado con la Ciudad Universitaria. Tiene una cancha de gramilla de 110 x90m con dos tribunas laterales para el disfrute de los espect??culos futbol??sticos entre otros que se desarrollan all??. Contiene adem??s una pista atl??tica y otros espacios para la modalidad de la misma.";
				mostrarMarcador(6.269207186719753, -75.56761734187603, "Cancha Sint??tica",infoSO, iconSo);
				
				String infoSO1 ="Creado con la Ciudad Universitaria. Tiene una cancha de gramilla de 110 x90m con dos tribunas laterales para el disfrute de los espect??culos futbol??sticos entre otros que se desarrollan all??. Contiene adem??s una pista atl??tica y otros espacios para la modalidad de la misma.";
				mostrarMarcador(6.269448141672462, -75.56949153542519, "Cancha de F??tbol",infoSO1, iconSo);
				
				int iconCT = R.drawable.tennis;
				String infoCT="La Universidad de Antioquia cuenta con 4 canchas de tenis en esta disciplina con piso en polvo de ladrillo las cuales cumplen con todas las condiciones para la pr??ctica de este deporte, de igual manera en este espacio se desarrollan las competencias que se ofrecen en los servicios del Departamento de Deportes, como tambi??n se realizan eventos de car??cter Universitario de Liga y Federaciones.";
				mostrarMarcador(6.268967231469515, -75.5682734772563, "Tennis de Campo",infoCT, iconCT);
				
				
				int iconPi = R.drawable.swim;
				String infoPi="El servicio se presta de lunes a domingo en los siguientes horarios:\n Ba??ista libre de 11:00 a 1:30 p.m. \n Deporte Formativo: 8:00 a 11:00 y de 2:00 a 4:00 p.m.\n Deporte Representativo: 6:00 a 8:00 a.m, y de 4:00 a 8:00 p.m.";
				mostrarMarcador(6.268940569768229, -75.5687190592289, "Piscina",infoPi, iconPi);
				
				int iconScuba = R.drawable.scubadiving;
				String infoScu="El ??rea acu??tica est?? compuesta por la piscina y el pozo, que ahora tienen una imagen renovada que cumple con los requerimientos exigidos para la pr??ctica y el Aprovechamiento del Tiempo Libre.";
				mostrarMarcador(6.26927617383378, -75.56869693100452, "Scuba", infoScu,iconScuba);
				
				int iconG = R.drawable.gym;
				String infoCo="Este espacio no re??ne las condiciones t??cnicas de un coliseo, pero se compone de escenarios que permiten la pr??ctica de los siguientes deportes Baloncesto, Voleibol, F??tbol Sala, Gimnasia, adem??s contiene espacios que permiten la pr??ctica de las siguientes disciplinas deportivas como Taekwondo, judo, aikido, karate-do, y levantamiento de pesas.";
				mostrarMarcador(6.269512129690994, -75.5687566101551, "Coliseo",infoCo, iconG);
				
				int iconB = R.drawable.basketball;
				String infoB ="La Universidad cuenta con 4 canchas de 28x15m en piso de asfalto, donde se desarrollan actividades deportivas de los servicios formativo, representativo y recreativo, en baloncesto, voleibol, futbolito, juegos m??ltiples entre otras, permanecen disponibles de 6:00 a 8:00 p.m.";
			...
			case R.id.menu_Salas_de_computadores:
				...
				mostrarMarcador(6.26781544473171, -75.56769981980324, "Telem??tica",infoC, iconC);
			...
			case R.id.menu_restroom:
				...
				mostrarMarcador(6.268442995517917, -75.56711744517088, "Ba??o Mujeres",infoR, iconR);
				mostrarMarcador(6.267995411577137, -75.56711744517088, "Ba??o Hombres",infoR, iconR);
				mostrarMarcador(6.267995411577137, -75.5675006678388, "Ba??o Mujeres", infoR, iconR);
				mostrarMarcador(6.268475656132965, -75.56745339185, "Ba??o Hombres",infoR, iconR);
				mostrarMarcador(6.267640476905802, -75.5677330121398, "Ba??os", infoR, iconR);
				mostrarMarcador(6.268063732307746, -75.56825671344995, "Ba??o Mujeres", infoR, iconR);
				mostrarMarcador(6.268453993480358, -75.56823659688234, "Ba??o Hombres", infoR,iconR);
				mostrarMarcador(6.268365676502711, -75.56863021105528, "Ba??os",infoR, iconR);
				break;
	...
	public ArrayList<Lugar> getItems(String query) {
		...
		//obtiene ubicaci??n del query mandado por el usuario
		try {
